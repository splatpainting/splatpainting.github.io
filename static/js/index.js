...
var INTERP_BASE = "./static/interpolated-car/dense-interpolated-car";
var NUM_INTERP_FRAMES = 13;

var interp_images = [];
function preloadInterpolationImages() {
  for (var i = 0; i < NUM_INTERP_FRAMES; i++) {
    var path = INTERP_BASE + '/' + String(i).padStart(1, '0') + '.png';
...
var INTERP_BASE2 = "./static/interpolated-sunflower/dense-interpolated-sunflower/";
var NUM_INTERP_FRAMES2 = 12;

var interp_images2 = [];
function preloadInterpolationImages2() {
  for (var i = 0; i < NUM_INTERP_FRAMES2; i++) {
    var path = INTERP_BASE2 + '/' + String(i).padStart(1, '0') + '.png';
...
$(document).ready(function() {
    ...
    $('#interpolation-slider-2').prop('max', NUM_INTERP_FRAMES2 - 1);
